...
${OBJECTDIR}/FontCharacterSet.o: FontCharacterSet.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FontCharacterSet.o FontCharacterSet.cpp

${OBJECTDIR}/FontRenderer.o: FontRenderer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FontRenderer.o FontRenderer.cpp
...
${OBJECTDIR}/pugixml-1.2/src/pugixml.o: pugixml-1.2/src/pugixml.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pugixml-1.2/src/pugixml.o pugixml-1.2/src/pugixml.cpp
